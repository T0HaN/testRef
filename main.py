...
from routers import auth, characters, master, player, websockets, dashboard, profile, creator, market
...
app.include_router(creator.creator_router)
app.include_router(market.market_router)
